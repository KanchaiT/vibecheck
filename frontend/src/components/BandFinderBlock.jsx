...
export default function BandFinderBlock({ postId, role, bandName, tags, author, postOwnerId, currentUser, onDelete }) {
        ...
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          {canDelete && (
            <button 
              ...
              className="p-2 text-white transition bg-red-500 border-2 border-black rounded-lg hover:bg-red-600 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none shrink-0"
              title="ลบโพสต์นี้"
            >
              <Trash2 size={18} />
            </button>
